...
class PptLoader extends base_loader_js_1.BaseLoader {
    constructor({ filePathOrUrl, chunkOverlap, chunkSize, }) {
        super(`PptLoader_${(0, md5_1.default)(filePathOrUrl)}`, { filePathOrUrl }, chunkSize ?? 1000, chunkOverlap ?? 0);
    ...
    async *getUnfilteredChunks() {
        ...
        const chunks = await chunker.splitText((0, strings_js_1.cleanString)(docxParsed));
